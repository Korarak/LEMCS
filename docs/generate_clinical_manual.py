...
add_note_box(doc,
    "กฎการเลือกแบบประเมิน: หากอายุ < 11 ปี → ระบบให้ทำ CDI  |  หากอายุ 11–20 ปี → ระบบให้ทำ PHQ-A  |  "
    "นักเรียนทุกคนสามารถทำ ST-5 ได้เสมอโดยไม่จำกัดอายุ",
    COLOR_INFO_BOX, "ℹ️")
...
add_body(doc,
    ...
    "ใช้สำหรับเด็กอายุ 7–17 ปี (ในระบบนี้กำหนดเฉพาะเด็กอายุต่ำกว่า 11 ปี)")
...
add_bullet(doc, "กฎการแบ่งอายุ (< 11 ปี → CDI / 11–20 ปี → PHQ-A) เหมาะสมหรือควรปรับช่วงอายุ?")
